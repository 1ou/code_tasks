 ...
 */
public class Task1474_C {

    static void removeSums(Map<Integer, Integer> m, int r) {
    ...
    static void solve() {
        ...
        for (int i = (n * 2) - 1; i >= 0; ) {
            ...
            while (sec >= 0) {
                int num = a[i] + a[sec];
                boolean isContains = sums.containsKey(num);
                if (isContains) {
                    Integer val = sums.get(num);
                    if (val == 1) {
                        sums.remove(num);
                    ...
                    if (first) {
                        stringBuilder.append(a[i] + a[sec]).append("\n");
                        first = false;
                    }
                    i--;
                    continue;
